...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.ViewHolderData> {
    ...
    public void onBindViewHolder(ViewHolderData holder, int position) {
        ...
        String formatPlaca1 = vehiculos.get(position).getPlaca().substring(0,3).toUpperCase();
        String formatPlaca2 = vehiculos.get(position).getPlaca().substring(3);
        holder.placa.setText(formatPlaca1+"-"+formatPlaca2);
